    ...
    <main className="flex min-h-[75vh] flex-col items-center justify-center px-4 py-16 bg-deep-navy relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-3 font-serif text-3xl text-on-surface">กลับสู่ห้องอ่านของคุณ</h1>
          <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-on-surface-variant/70">
            เข้าสู่ระบบเพื่อเก็บบทความ แนวคิด และความคืบหน้าการอ่าน
        ...
        <SignIn
          ...
          appearance={{
            ...
            elements: {
              ...
              formFieldInput: "border-ink/10 bg-charcoal/70 text-ivory outline-none focus:border-antique-gold/60 rounded-sm py-2 px-3",
              identityPreviewText: "text-ivory",
              identityPreviewEditButtonIcon: "text-antique-gold",
              socialButtonsBlockButton: "border border-ink/10 bg-charcoal/60 text-ivory hover:bg-ink/5 hover:border-antique-gold/40 rounded-sm",
