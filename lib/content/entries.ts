...
export const entries: ContentEntry[] = [
  {
    ...
    references: [
      ...
      { sourceType: "editorial-interpretation", title: "การเรียบเรียงของ The Soul's Compass", relatedClaim: "สรุปภาพรวมเพื่อการอ่าน — เป็นการตีความ ไม่ใช่ข้อความจากแหล่งต้นทาง" },
    ],
    roots: {
...

  {
    ...
    references: [
      ...
      { sourceType: "editorial-interpretation", title: "การเรียบเรียงของ The Soul's Compass", relatedClaim: "คำอธิบายเบื้องต้นเพื่อผู้อ่านใหม่" },
    ],
    roots: {
...

  {
    ...
    references: [
      ...
      { sourceType: "editorial-interpretation", title: "การเรียบเรียงของ The Soul's Compass", relatedClaim: "คำอธิบายเชิงปฏิบัติเพื่อการอ่าน" },
    ],
...

  {
    ...
    references: [
      ...
      { sourceType: "editorial-interpretation", title: "การเรียบเรียงของ The Soul's Compass", relatedClaim: "เน้นย้ำว่า individuation ไม่ใช่ self-help" },
    ],
